 ...
 * @author Adel Amer
 */
public class cachirHome extends javax.swing.JFrame {

    /**
     * Creates new form cachirHome
     */
    public cachirHome() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cachirHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cachirHome().setVisible(true);
            }
        });
    }
